...
public class SpielOberflaeche extends Application implements UserInterface {
	...
	/**
	 * Die Stage ist der Schauplatz für die verschiedenen Scenen, die in der GUI
	 * gezeigt werden.
	 */
	@Override
	public void start(Stage hauptfenster) {
		...
		/*
		 * Client bekommt dieses Objekt übergeben und kann dann die Methode
		 * spielbrettVeraendert() aufrufen
		 */
		...
		anmeldung.getStylesheets().add(SpielOberflaeche.class.getResource("Background.css").toExternalForm());
		...
		/*
		 * Aktion für den Anmeldungsbutton: Das Spielfeld wird angezeigt, der
		 * Client bekommt einen Namen und eine IP-Adresse und meldet sich an
		 */
		...
		regelnBtn.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				String regelnString = "Zu Beginn werden in jede runde Mulde der Spieler 4 Steine gelegt \n"
				...
				zurueckBtn.setStyle(
						" -fx-base: #0000B8; -fx-focus-color: transparent; -fx-faint-focus-color: transparent;");
				...
				regeln.getStylesheets().add(SpielOberflaeche.class.getResource("Background.css").toExternalForm());
		...
		neuesSpielStartenBtn
				.setStyle(" -fx-base: #009933; -fx-focus-color: transparent; -fx-faint-focus-color: transparent;");
		...
		/*
		 * Mulden Buttons für das Spiel. Die Buttons 0-11 können die Methode
		 * muldeSpielen des Clients aufrufen.
		 */
		buttonA = new Button();
		...
		buttonA.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonBlue.css").toExternalForm());
		...
		button0.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonBlue.css").toExternalForm());
		...
		button1.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonBlue.css").toExternalForm());
		...
		button2.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonBlue.css").toExternalForm());
		...
		button3.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonBlue.css").toExternalForm());
		...
		button4.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonBlue.css").toExternalForm());
		...
		button5.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonBlue.css").toExternalForm());
		...
		button6.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonGreen.css").toExternalForm());
		...
		button7.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonGreen.css").toExternalForm());
		...
		button8.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonGreen.css").toExternalForm());
		...
		button9.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonGreen.css").toExternalForm());
		...
		button10.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonGreen.css").toExternalForm());
		...
		button11.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonGreen.css").toExternalForm());
		...
		buttonB.getStylesheets().add(SpielOberflaeche.class.getResource("ButtonGreen.css").toExternalForm());
		buttonB.setMinWidth(120);
		buttonB.setMinHeight(260);
		buttonB.setStyle("-fx-stroke: firebrick; -fx-stroke-width: 2px;");

		/*
		 * Erstellung der GridPanes. Es gibt ein Grid für die Muldenbuttons und
		 * eins für den Chat. Die Elemente werden hier angeordnet.
		 */
		...
		spielfeld.getStylesheets().add(SpielOberflaeche.class.getResource("Background.css").toExternalForm());
	...
	/**
	 * Die Methode uebergibt der Runner-Klasse das Spielbrett, sodass dieses
	...
	/**
	 * Die Methode uebergibt der Runner-Klasse eine Chat-Nachricht, sodass der
	 * Chat aktualisiert werden kann.
	 */
	@Override
